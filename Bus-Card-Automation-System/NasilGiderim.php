...
<body>
    ...
    <div style="text-align: center; margin-top: 200px;">
        <div class="card" style="width: 370px; display: inline-block; margin: 10px;">
        ...
        <div class="card" style="width: 350px; display: inline-block; margin: 10px;">
        ...
        <div class="card" style="width: 380px; display: inline-block; margin: 10px;">
